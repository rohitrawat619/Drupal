...
/**
 * Provides dynamic permissions of the transform_api module.
 */
class TransformPermissions implements ContainerInjectionInterface {
  ...
  public function fieldPermissions() {
    ...
    foreach ($this->entityTypeManager->getDefinitions() as $entity_type_id => $entity_type) {
      if ($entity_type->get('field_ui_base_route')) {
        ...
        // the transforms.
        $permissions['administer ' . $entity_type_id . ' transform'] = [
          'title' => $this->t('%entity_label: Administer transform', ['%entity_label' => $entity_type->getLabel()]),
