...
/**
 * Manages discovery and instantiation of transform block plugins.
 *
 * @todo Add documentation to this class.
 *
 * @see \Drupal\transform_api\TransformBlockInterface
 */
class TransformBlockManager extends DefaultPluginManager implements TransformBlockManagerInterface, FallbackPluginManagerInterface {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler, LoggerInterface $logger) {
    parent::__construct('Plugin/Transform/Block', $namespaces, $module_handler, 'Drupal\transform_api\TransformBlockPluginInterface', 'Drupal\transform_api\Annotation\TransformBlock');

    $this->alterInfo($this->getType());
    $this->setCacheBackend($cache_backend, 'transform_block_plugins');
    $this->logger = $logger;
  }
